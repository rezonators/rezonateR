...
obj$rezDF$default = obj$rezDF$default %>% mutate(subject = findSubject(obj$rezDF$default, obj$trackDF$default, obj$treeEntryDF$default))

predDF = obj$rezDF$default %>% rez_left_join(obj$trackDF$default, df2Address = "trackDF/default", fkey = "subject", suffix = c("", "_subj"))
