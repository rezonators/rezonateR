...
Ready to use rezonateR? If so, run this in R:

```{r, eval = FALSE}
install.packages("devtools")
library(devtools)
install_github("johnwdubois/rezonateR")
```
...
names(myRez$chunkDF)
print(head(myRez$chunkDF$refexpr))
```
...
```{r}
myRez = myRez %>% addFieldForeign("track", "refexpr", "treeEntry", "", "treeEntry", "treeParent", "parent", fieldaccess = "foreign")
