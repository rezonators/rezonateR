...
```{r}
View(myRez$nodeMap$token) #Need to delete in the real vignette
``` 
...
```{r}
View(myRez$unitDF %>% filter(str_detect(word, "<0>")) %>% rez_select(id, word, wordWylie)) 
...
myRez = addField(myRez, entity = "token", layer = "",
                 ...
                 fieldaccess = "auto")
View(viewCorePlus(myRez$tokenDF, c("word", "orthoLength")))
```
...
myRez = addField(myRez, entity = "token", layer = "",
                 ...
                 groupField = "unit",
                 fieldaccess = "auto")
View(viewCorePlus(myRez$tokenDF %>% arrange(unit, discourseTokenSeq), c("word", "longestWordInUnit")))
```
...
myRez = addFieldForeign(myRez,
                ...
                fieldaccess = "foreign")
View(viewCorePlus(myRez$tokenDF %>% arrange(unit, discourseTokenSeq), c("word", "unitWord")))
```
...
myRez = addFieldForeign(myRez,
                ...
                fieldaccess = "foreign")
View(viewCorePlus(myRez$unitDF %>% arrange(unitSeq), c("word", "shortestWordLength")))
```
